import { O as commonjsGlobal, Q as getDefaultExportFromCjs, r as reactExports, V as clsx, R as React, W as invariant, d as useActor, e as useQuery, j as jsxRuntimeExports, f as createActor } from "./index-Dtbu2WTs.js";
...
function generateRevenueData(totalRevenue) {
  const days = 30;
  const today = /* @__PURE__ */ new Date();
  return Array.from({ length: days }).map((_, i) => {
    const d2 = new Date(today);
    d2.setDate(d2.getDate() - (days - 1 - i));
    const base = totalRevenue / days;
    const variance = base * (0.4 + Math.sin(i * 0.8) * 0.4);
    return {
      day: d2.toLocaleDateString("en-IN", { day: "numeric", month: "short" }),
      revenue: Math.round(Math.max(0, base + variance))
    };
  });
}
function generateBookingTrend(totalBookings) {
  const days = 14;
  const today = /* @__PURE__ */ new Date();
  return Array.from({ length: days }).map((_, i) => {
    const d2 = new Date(today);
...
function MetricCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: `font-display text-2xl font-bold ${color2}`, children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-0.5 text-xs font-semibold text-foreground", children: label }),
...
function AdminAnalyticsPage() {
  ...
  const totalBookings = Number((analytics == null ? void 0 : analytics.totalBookings) ?? 0n);
  const totalRevenue = Number((analytics == null ? void 0 : analytics.totalRevenue) ?? 0n);
  const refunds = Number((analytics == null ? void 0 : analytics.refundsProcessed) ?? 0n);
  const refundRate = totalBookings > 0 ? (refunds / totalBookings * 100).toFixed(1) : "0.0";
  const revenueData = reactExports.useMemo(
    () => generateRevenueData(totalRevenue),
    [totalRevenue]
  );
  const bookingData = reactExports.useMemo(
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", "data-ocid": "admin_analytics.page", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-xl font-bold", children: "Analytics" }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 lg:grid-cols-3", children: Array.from({ length: 6 }).map((_, i) => (
      // biome-ignore lint/suspicious/noArrayIndexKey: skeleton
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-24 rounded-xl" }, i)
    )) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 gap-3 lg:grid-cols-3", children: metrics.map((m2) => /* @__PURE__ */ jsxRuntimeExports.jsx(MetricCard, { ...m2 }, m2.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 text-sm font-semibold", children: "Revenue — Last 30 Days" }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-48 w-full rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 200, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        BarChart,
        {
          data: revenueData,
          ...
          children: [
            ...
            revenueData.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Cell,
              {
                fill: i % 2 === 0 ? "oklch(0.56 0.26 16.8)" : "oklch(0.68 0.22 16.8)"
              },
              entry.day
            )),
            /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "revenue", radius: [4, 4, 0, 0], children: revenueData.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Cell,
              {
                fill: i % 2 === 0 ? "oklch(0.56 0.26 16.8)" : "oklch(0.72 0.18 16.8)"
              },
              entry.day
            )) })
          ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-border bg-card p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "mb-4 text-sm font-semibold", children: "Booking Trend — Last 14 Days" }),
      isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-40 w-full rounded-lg" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 160, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        LineChart,
        {
          data: bookingData,
